...
**自维护的 VS Code 扩展，用于在 GitHub Copilot Chat 中使用 OpenAI/Ollama/Anthropic/Gemini API 兼容供应商，并内置 OpenAI、Anthropic、Kimi、DeepSeek、小米 MiMo、MiniMax 预设** 🔥
...
- **供应商用量检查**：在独立的 Provider Usage Check 表格中查看 DeepSeek/Kimi 余额、MiniMax token 套餐剩余额度，以及 OpenAI/Anthropic 当月费用用量；小米 MiMo 会显示为暂不可用，直到小米发布公开的 API key 用量端点
